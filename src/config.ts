...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    // site description
    description: 'Jennifer Builds — a personal engineering blog about AI, agents, LLMs, and building software.',
    // use i18n title/subtitle/description from src/i18n/ui.ts instead of static ones above
    i18nTitle: true, // true | false
    // author name
    author: 'Jennifer',
    // site url
    url: 'https://jenniferbuilds.github.io',
    // base path
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'GitHub',
        url: 'https://github.com/jenniferbuilds',
      },
      {
        name: 'LinkedIn',
